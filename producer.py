...
# # Function to fetch and process data for a specific hour
# def fetch_and_process_data(start_datetime, end_datetime):
#     url = "https://archive-api.open-meteo.com/v1/archive"
    
#     # Use only the 'YYYY-MM-DD' format for start_date and end_date
#     params = {
#         "latitude": 52.52,
#         "longitude": 13.41,
